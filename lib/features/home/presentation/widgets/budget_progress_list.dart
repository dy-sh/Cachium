        ...
        children: [
          Row(
            children: [
              ...
              Text(
                '${CurrencyFormatter.formatSimple(progress.spent, currencyCode: ref.watch(mainCurrencyCodeProvider))} / ${CurrencyFormatter.formatSimple(progress.effectiveBudget, currencyCode: ref.watch(mainCurrencyCodeProvider))}',
