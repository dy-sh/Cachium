...
- Add ability to mark a transaction as recurring with frequency (weekly/biweekly/monthly/yearly)
- Show upcoming scheduled transactions on the home screen
- Option to auto-create or prompt for confirmation when due

#### 2. Transaction templates / Quick Add
- Save frequently used transactions as templates (amount, category, account, merchant pre-filled)
...
- Examples: "vacation", "tax-deductible", "shared-expense"
...
- Let users arrange: accounts, balance, quick actions, recent transactions in any order

#### 6. Dark/Light theme toggle
- Currently dark-only
- Some users prefer light mode, especially outdoors
- The color intensity system could map to light mode variants
