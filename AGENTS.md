...
This agent updates docs/features.md and docs/features_new.md to reflect new routes, providers, models, services, or architectural patterns introduced by the feature.

**IMPORTANT:** When adding new critical rules, conventions, or architectural patterns to CLAUDE.md, also update AGENTS.md to keep it in sync. AGENTS.md is a concise version of these instructions for non-Claude agents (Codex, etc.).
